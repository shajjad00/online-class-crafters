          ...
          <div className="p-5 sm:w-2/12 border-r">
            ...
            <ul>
              ...
              <li className="my-2">
                <Link
                  className="hover:text-[#346B8D]"
                  to="/teachOnClassCrafters"
                >
                  Teach on Class Crafters
                </Link>
              </li>
            </ul>
          </div>
          <div className="p-5 sm:w-7/12 border-r text-center">
            <h3 className="font-bold text-xl text-[#346B8D] mb-4">About Us</h3>
            <p className="text-gray-500 text-sm mb-10">
              Welcome to our food community—a hub of culinary enthusiasts,
              chefs, and home cooks! Here, we embrace diverse flavors, recipes,
              and stories. Join us in celebrating the joy of cooking, sharing
              experiences, and creating connections. Together, we explore the
        ...
        <div className="flex py-5 m-auto text-gray-800 text-sm flex-col items-center border-t max-w-screen-xl">
          <div className="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
            <a className="w-6 mx-1">
              <svg
                className="fill-current cursor-pointer text-gray-500 hover:text-[#346B8D]"
                width="100%"
                height="100%"
                viewBox="0 0 24 24"
                version="1.1"
